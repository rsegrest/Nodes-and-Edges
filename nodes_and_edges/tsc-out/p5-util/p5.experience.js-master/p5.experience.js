            ...
            switch (this.shape) {
                case 'rect':
                    this.shadowRender = () => {
                        ...
                        if (this.uxRectModeState === 'center') {
                            rect(this.x + this.wBlur + this.offX - this.w / 2, this.y + this.wBlur + this.offY - this.h / 2, this.w - this.wBlur * 2, this.h - this.wBlur * 2, this.cor);
                        }
                        else {
                            rect(this.x + this.wBlur + this.offX, this.y + this.wBlur + this.offY, this.w - this.wBlur * 2, this.h - this.wBlur * 2, this.cor);
                        }
                        ...
                        for (let i = 0; i < off; i++) {
                            ...
                            if (this.uxRectModeState === 'center') {
                                rect(this.x + this.offX + this.wBlur - i - this.w / 2, this.y + this.offY + this.wBlur - i - this.h / 2, this.w - this.wBlur * 2 + i * 2 - 1, this.h - this.wBlur * 2 + i * 2 - 1, this.cor);
                            }
                            else {
                                rect(this.x + this.offX + this.wBlur - i, this.y + this.offY + this.wBlur - i, this.w - this.wBlur * 2 + i * 2 - 1, this.h - this.wBlur * 2 + i * 2 - 1, this.cor);
                            }
                        }
                    };
                    break;
                case 'square':
                    this.shadowRender = () => {
                        ...
                        rectMode(CORNER);
                        if (this.uxRectModeState === 'center') {
                            square(this.x + this.wBlur + this.offX - this.s / 2, this.y + this.wBlur + this.offY - this.s / 2, this.s - this.wBlur * 2, this.cor);
                        }
                        else {
                            square(this.x + this.wBlur + this.offX, this.y + this.wBlur + this.offY, this.s - this.wBlur * 2, this.cor);
                        }
                        const off = Math.round(this.wBlur * 1.2);
                        for (let i = 0; i < off; i++) {
                            noFill();
                            ...
                            stroke(this.shadowColor, map(i, 0, off, 255, 0));
                            if (this.uxRectModeState === 'center') {
                                square(this.x + this.offX + this.wBlur - i - this.s / 2, this.y + this.offY + this.wBlur - i - this.s / 2, this.s - this.wBlur * 2 + i * 2 - 1, this.cor);
                            }
                            else {
                                square(this.x + this.offX + this.wBlur - i, this.y + this.offY + this.wBlur - i, this.s - this.wBlur * 2 + i * 2 - 1, this.cor);
                            }
                        }
                    };
                    break;
                case 'triangle':
                    this.shadowRender = () => {
                        ...
                        triangle(xi1 + this.offX, yi1 + this.offY, xi2 + this.offX, yi2 + this.offY, xi3 + this.offX, yi3 + this.offY);
                        const off = Math.round(this.wBlur * 1.2);
                        for (let i = 0; i < off; i++) {
                            noFill();
                            strokeWeight(3);
                            stroke(this.shadowColor, map(i, 0, off, 255, 0));
                            triangle(map(this.wBlur - i, 50, 0, cX, this.x1) + this.offX, map(this.wBlur - i, 50, 0, cY, this.y1) + this.offY, map(this.wBlur - i, 50, 0, cX, this.x2) + this.offX, map(this.wBlur - i, 50, 0, cY, this.y2) + this.offY, map(this.wBlur - i, 50, 0, cX, this.x3) + this.offX, map(this.wBlur - i, 50, 0, cY, this.y3) + this.offY);
                        }
                    };
                    break;
                case 'ellipse':
                    this.shadowRender = () => {
                        ...
                        ellipseMode(CENTER);
                        if (this.uxEllipseModeState === 'corner') {
                            ellipse(this.x + this.offX + this.w / 2, this.y + this.offY + this.h / 2, this.w - this.wBlur * 2, this.h - this.wBlur * 2);
                        }
                        else {
                            ellipse(this.x + this.offX, this.y + this.offY, this.w - this.wBlur * 2, this.h - this.wBlur * 2);
                        }
                        noFill();
                        const off = Math.round(this.wBlur * 1.2);
                        for (let i = 0; i < off; i++) {
                            ...
                            stroke(this.shadowColor, map(i, 0, off, 255, 0));
                            if (this.uxEllipseModeState === 'corner') {
                                ellipse(this.x + this.offX + this.w / 2, this.y + this.offY + this.h / 2, this.w - this.wBlur * 2 + i * 2 - 1, this.h - this.wBlur * 2 + i * 2 - 1);
                            }
                            else {
                                ellipse(this.x + this.offX, this.y + this.offY, this.w - this.wBlur * 2 + i * 2 - 1, this.h - this.wBlur * 2 + i * 2 - 1);
                            }
                        }
                    };
                    break;
                case 'circle':
                    this.shadowRender = () => {
                        ...
                        ellipseMode(CENTER);
                        if (this.uxEllipseModeState === 'corner') {
                            ellipse(this.x + this.offX + this.d / 2, this.y + this.offY + this.d / 2, this.d - this.wBlur * 2);
                        }
                        else {
                            ellipse(this.x + this.offX, this.y + this.offY, this.d - this.wBlur * 2);
                        }
                        noFill();
                        const off = Math.round(this.wBlur * 1.2);
                        for (let i = 0; i < off; i++) {
                            ...
                            stroke(this.shadowColor, map(i, 0, off, 255, 0));
                            if (this.uxEllipseModeState === 'corner') {
                                ellipse(this.x + this.offX + this.d / 2, this.y + this.offY + this.d / 2, this.d - this.wBlur * 2 + i * 2 - 1);
                            }
                            else {
                                ellipse(this.x + this.offX, this.y + this.offY, this.d - this.wBlur * 2 + i * 2 - 1);
                            }
                        }
                    };
                    break;
