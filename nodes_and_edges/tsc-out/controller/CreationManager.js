...
export class CreationManager {
    ...
    static createNewObjectFromDynamicTool(dynamicTool) {
        const objectsNewPos = dynamicTool === null || dynamicTool === void 0 ? void 0 : dynamicTool.getPosition();
        const objectsNewDim = dynamicTool === null || dynamicTool === void 0 ? void 0 : dynamicTool.getDimensions();
    ...
    static tryToMakeConnection() {
        ...
        if (plugs && plugs.length === 2) {
            ...
            const edge = new EdgeModel(Math.floor(Math.random() * 100000).toString(), sourceNode, targetNode, sourcePlug, targetPlug);
    ...
    static createContainer(p, parent) {
        ...
        container.setAttribute('style', "position: absolute; top: 100px; left: 100px; background: #f00; width: 10px; height: 10px;");
    ...
    static createNodes() {
        ...
        for (let i = 0; i < 4; i += 1) {
            ...
            const node = new NodeModel(id, label, position, dimension, inputParameterList, outputParameterList);
            nodes.push(node);
        }
        return nodes;
    }
    static createEdges(nodes) {
        ...
        const oneEdge = new EdgeModel('e0-1', firstNode1, secondNode1, firstPlug1, secondPlug1);
        ...
        const anotherEdge = new EdgeModel('e1-2', firstNode2, secondNode2, firstPlug2, secondPlug2);
        ...
        const yetAnotherEdge = new EdgeModel('e2-3', firstNode3, secondNode3, firstPlug3, secondPlug3);
